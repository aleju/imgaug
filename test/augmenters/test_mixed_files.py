...
def test_dtype_preservation():
    ...
    augs = [
        ...
        (iaa.Alpha((0.0, 0.1), iaa.Identity(), name="AlphaIdentity"),
         default_dtypes),
        (iaa.AlphaElementwise((0.0, 0.1), iaa.Identity(),
                              name="AlphaElementwiseIdentity"),
         default_dtypes),
        (iaa.SimplexNoiseAlpha(iaa.Identity(),
                               name="SimplexNoiseAlphaIdentity"),
         default_dtypes),
        (iaa.FrequencyNoiseAlpha(exponent=(-2, 2), first=iaa.Identity(),
                                 name="SimplexNoiseAlphaIdentity"),
         default_dtypes),
        (iaa.Alpha((0.0, 0.1), iaa.Add(10), name="Alpha"),
         _not_dts([np.uint32, np.int32, np.float64])),
